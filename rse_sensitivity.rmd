...
lambda_R_12345 <- c(10000, 1000, 100, 10, 1)
...
layout(matrix(c(1, 2), nrow = 2, ncol = 1, byrow = T), widths = rep(1, 1), heights = rep(1, 2))
#layout.show(2)
par(mar=c(0, 5, 1, 0.1), oma = c(4, 2, 0.1, 0.1))
...
legend("topleft", legend = c("1 (10,000)", "2 (1,000)", "3 (100)", "4 (10)", "5 (1)"), col = cols1, lty = c(1:5), lwd = 2, bty = "n", ncol = 1, cex = 0.9)

...
n_rep <- 100 # number of random replications to do
...
out_pars <- matrix(c(0, 0, 0, 0, 0), nrow = years, ncol = n, byrow = T) # outplant 10,000 of the first size class each year?
...
plot(x = lambda_set, y = N_set, type = "p", pch = 16, las = 1, col = adjustcolor("black", alpha.f = 0.6))

# maybe plots of proportion in each size class, with different colors for the different size classes?

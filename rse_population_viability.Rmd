...
n_reps <- 10 # number of random replications to do
...
out_pars <- matrix(10000, nrow = years, ncol = n) # never outplant any

# holding vectors
# final reef population size
# final reef size structure
...
frag_pars.r[[1]][[1]] <- list(NULL, c(0), c(0, 0), c(0, 0.015, 0.015), c(0, 0.07, 0.08, 0.06)) 

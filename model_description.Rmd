...
number of adults in orchard goes down below max because corals die so it's not possible to keep it 100% full (which seems realistic?), but if you make survival 100% then it does fill up (or even just survival of size classes 1 and 2). 

...
m0 <- c(0.01, 0.01) # density dependent mortality rate of larvae in each lab treatment that get outplanted immediately
m1 <- c(0.01, 0.01) # density dependent mortality rate of larvae in each lab treatment that get outplanted after 1 year
...
put things in terms of tiles (don't really have 10000 competing with each other) and add it in the lab

...
# par_name = name of the parameter to iterate over (NOTE: function currently only allows for parameters that are in rest_pars list or production from the reference reef)
...
#layout.show(2)
par(mar=c(0, 2.5, 2.5, 1), oma = c(4.5, 2.5, 2, 0))
...
ADD TIMESERIES WITH AND WITHOUT ORCHARD FRAGMENTATION
...
-- lab capacity
-- orchard capacity
-- orchard fecundity, orchard fecundity x reference reef supply

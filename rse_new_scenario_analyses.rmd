...
tic()
orch_D0_all <- orch_exp_fun2(dem_pars_all = all_pars_R, n_pars = n_sample1, prop_set = prop_all, par_set2 = lambda_Rs[2], par2_name = "lambda_R", dist = F, dist_yrs = NULL, dist_pars_list = NULL)

orch_D3_all <- orch_exp_fun2(dem_pars_all = all_pars_R, n_pars = n_sample1, prop_set = prop_all, par_set2 = lambda_Rs[2], par2_name = "lambda_R", dist = T, dist_yrs = dist_yrs3, dist_pars_list = dist_pars_list3)
toc()

# process the data

orch_D0_all_dt5 <- full_dt_fun(sim_list = orch_D0_all, max_yr = 6, n_pars = n_sample1, prop_set = prop_all, par_set2 = lambda_Rs[2], par2_name = "lambda_R")
orch_D0_all_dt50 <- full_dt_fun(sim_list = orch_D0_all, max_yr = 51, n_pars = n_sample1, prop_set = prop_all, par_set2 = lambda_Rs[2], par2_name = "lambda_R")

orch_D3_all_dt5 <- full_dt_fun(sim_list = orch_D3_all, max_yr = 6, n_pars = n_sample1, prop_set = prop_all, par_set2 = lambda_Rs[2], par2_name = "lambda_R")
orch_D3_all_dt50 <- full_dt_fun(sim_list = orch_D3_all, max_yr = 51, n_pars = n_sample1, prop_set = prop_all, par_set2 = lambda_Rs[2], par2_name = "lambda_R")

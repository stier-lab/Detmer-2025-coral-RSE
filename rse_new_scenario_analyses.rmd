...
plot(x = prop_set, y = ceiling(rest_pars$lab_max*prop_set/2000), type = "l", ylim = c(0, 6), las = 1, ylab = "Days spent outplanting", xlab = "Prop. outplanted to reef")
...
labs1 <- as.character(round(mean(dt_plot2$reef_ROI_mean), 4))
...
yrs_p <- years # number of years to plot

xlab1 <- "Proportion substrates initially outplanted to reef"
ylab1 <- expression("Reef cover ("*m^2*")")
#plotlab <- "c) Reef ROI"
plot(x = c(1:yrs_p), y = rep(0, yrs_p), type = "l", col = NA, ylim = c(0, 60), las = 1, xlab = NA, ylab = NA)
mtext(side = 1, xlab1, line = 2.5, outer = T, cex = lab_cx)
mtext(side = 2, ylab1, line = 3.5, cex = lab_cx)
#mtext(side = 3, plotlab, adj = 0)
for(j in 1:length(prop_set_short)){
...
legend("topleft", legend = c("1", "50", "99"), col = prop_cols, lwd = 3, title = "% Initially \noutplanted to reef", bty = "n", cex = 0.75, inset = c(0, 0.1))
legend("bottomright", legend = c("default", "none"), lty = c(1, 2), title = "Reference reef supply", bty = "n", cex = 0.75, lwd = 2)
...
ylab1 <- expression("Orchard function ("*m^2~"adults)")
#plotlab <- "c) Reef ROI"
plot(x = c(1:yrs_p), y = rep(0, yrs_p), type = "l", col = NA, ylim = c(0, 6000), las = 1, xlab = NA, ylab = NA)
mtext(side = 1, xlab1, line = 2.5, outer = T, cex = lab_cx)
mtext(side = 2, ylab1, line = 3.5, cex = lab_cx)
#mtext(side = 3, plotlab, adj = 0)
for(j in 1:length(prop_set_short)){
 ...
 orch_fun_ij <- model_summ(model_sim = sim_ij, location = "orchard", metric = "area_m2", n_reef = length(reef_treatments), n_orchard = length(orchard_treatments), n_lab = length(lab_treatments), size_classes = c(3, 4, 5))
  ...
  lines(x = c(1:yrs_p), y = orch_fun_ij[1:yrs_p], col = prop_cols[j], lwd = 2, lty = 2)
  
   sim_ij <- plot_sims[[2]][[j]] 
 orch_fun_ij <- model_summ(model_sim = sim_ij, location = "orchard", metric = "area_m2", n_reef = length(reef_treatments), n_orchard = length(orchard_treatments), n_lab = length(lab_treatments), size_classes = c(3, 4, 5))
 
 lines(x = c(1:yrs_p), y = orch_fun_ij[1:yrs_p], col = prop_cols[j], lwd = 2)
...
ylab1 <- "Substrates in orchard"
#plotlab <- "c) Reef ROI"
plot(x = c(1:yrs_p), y = rep(0, yrs_p), type = "l", col = NA, ylim = c(0, rest_pars$orchard_size), las = 1, xlab = NA, ylab = NA)
mtext(side = 1, xlab1, line = 2.5, outer = T, cex = lab_cx)
mtext(side = 2, ylab1, line = 3.5, cex = lab_cx)
#mtext(side = 3, plotlab, adj = 0)
for(j in 1:length(prop_set_short)){
  sim_ij <- plot_sims[[1]][[j]] 
  lines(x = c(1:yrs_p), y = sim_ij$orchard_tiles[[1]][1:yrs_p], col = prop_cols[j], lwd = 2, lty = 2)
  
  sim_ij <- plot_sims[[2]][[j]] 
  lines(x = c(1:yrs_p), y = sim_ij$orchard_tiles[[1]][1:yrs_p], col = prop_cols[j], lwd = 2)
}
abline(h = rest_pars$orchard_size, lty = 2)
...
ylab1 <- "Substrates used"
#plotlab <- "c) Reef ROI"
plot(x = c(1:yrs_p), y = rep(0, yrs_p), type = "l", col = NA, ylim = c(0, rest_pars$lab_max), las = 1, xlab = NA, ylab = NA)
mtext(side = 1, xlab1, line = 2.5, outer = T, cex = lab_cx)
mtext(side = 2, ylab1, line = 3.5, cex = lab_cx)
#mtext(side = 3, plotlab, adj = 0)
for(j in 1:length(prop_set_short)){
  sim_ij <- plot_sims[[1]][[j]] 
  lines(x = c(1:yrs_p), y = sim_ij$tiles_out_tot[1:yrs_p], col = prop_cols[j], lwd = 2, lty = 2)
  
  sim_ij <- plot_sims[[2]][[j]] 
  lines(x = c(1:yrs_p), y = sim_ij$tiles_out_tot[1:yrs_p], col = prop_cols[j], lwd = 2)
}
abline(h = rest_pars$lab_max, lty = 2)
...
ylab1 <- expression("Reef cover ("*m^2*")")
#plotlab <- "c) Reef ROI"
plot(x = c(1:yrs_p), y = rep(0, yrs_p), type = "l", col = NA, ylim = c(0, 110), las = 1, xlab = NA, ylab = NA)
mtext(side = 1, xlab1, line = 2.5, outer = T, cex = lab_cx)
mtext(side = 2, ylab1, line = 3.5, cex = lab_cx)
#mtext(side = 3, plotlab, adj = 0)
for(j in 1:length(prop_set_short)){
...
legend("topleft", legend = c("1", "50", "99"), col = prop_cols, lwd = 3, title = "% Initially \noutplanted to reef", bty = "n", cex = 0.75, inset = c(0, 0.1))
legend("bottomright", legend = c("default", "2x default"), lty = c(1, 2), title = "Lab capacity", bty = "n", cex = 0.75, lwd = 2)
...
for(j in 1:length(prop_set_short)){
  sim_ij <- plot_sims[[1]][[j]] 
  lines(x = c(1:yrs_p), y = sim_ij$orchard_tiles[[1]][1:yrs_p], col = prop_cols[j], lwd = 2, lty = 1)
...
ylab1 <- "Substrates used"
#plotlab <- "c) Reef ROI"
plot(x = c(1:yrs_p), y = rep(0, yrs_p), type = "l", col = NA, ylim = c(0, rest_pars$lab_max*2), las = 1, xlab = NA, ylab = NA)
mtext(side = 1, xlab1, line = 2.5, outer = T, cex = lab_cx)
mtext(side = 2, ylab1, line = 3.5, cex = lab_cx)
#mtext(side = 3, plotlab, adj = 0)
for(j in 1:length(prop_set_short)){
  sim_ij <- plot_sims[[1]][[j]] 
  lines(x = c(1:yrs_p), y = sim_ij$tiles_out_tot[1:yrs_p], col = prop_cols[j], lwd = 2, lty = 1)
  
  sim_ij <- plot_sims[[2]][[j]] 
  lines(x = c(1:yrs_p), y = sim_ij$tiles_out_tot[1:yrs_p], col = prop_cols[j], lwd = 2, lty = 2)
}
abline(h = lab_max_set[1], lty = 2)
abline(h = lab_max_set[2], lty = 2)
...
for(j in 1:length(prop_set_short)){
  ...
  lines(x = c(1:yrs_p), y = reef_cover_ij[1:yrs_p], col = prop_cols[j], lwd = 1.75, lty = 1)
  
  sim_ij <- plot_sims[[2]][[j]] 
  reef_cover_ij <- model_summ(model_sim = sim_ij, location = "reef", metric = "area_m2", n_reef = length(reef_treatments), n_orchard = length(orchard_treatments), n_lab = length(lab_treatments))
  
  lines(x = c(1:yrs_p), y = reef_cover_ij[1:yrs_p], col = prop_cols[j], lwd = 2.5, lty = 2)
}
legend("topleft", legend = c("1", "50", "99"), col = prop_cols, lwd = 3, title = "% Initially \noutplanted to reef", bty = "n", cex = 0.75, inset = c(0, 0.1))
legend("bottomright", legend = c("default", "2x default"), lty = c(1, 2), title = "Orchard capacity", bty = "n", cex = 0.75, lwd = 2)


xlab1 <- "Proportion substrates initially outplanted to reef"
ylab1 <- expression("Orchard function ("*m^2~"adults)")
#plotlab <- "c) Reef ROI"
plot(x = c(1:yrs_p), y = rep(0, yrs_p), type = "l", col = NA, ylim = c(0, 10000), las = 1, xlab = NA, ylab = NA)
mtext(side = 1, xlab1, line = 2.5, outer = T, cex = lab_cx)
mtext(side = 2, ylab1, line = 3.5, cex = lab_cx)
#mtext(side = 3, plotlab, adj = 0)
for(j in 1:length(prop_set_short)){
...
ylab1 <- "Substrates in orchard"
#plotlab <- "c) Reef ROI"
plot(x = c(1:yrs_p), y = rep(0, yrs_p), type = "l", col = NA, ylim = c(0, rest_pars$orchard_size*2), las = 1, xlab = NA, ylab = NA)
mtext(side = 1, xlab1, line = 2.5, outer = T, cex = lab_cx)
mtext(side = 2, ylab1, line = 3.5, cex = lab_cx)
#mtext(side = 3, plotlab, adj = 0)
for(j in 1:length(prop_set_short)){
...
doubling orchard size doesn't have a huge effect on the reef bc the lab is already full (basically no effect for 99% case bc lab is the pinch point), so really the main effect you see is the greater lag in filling up the orchard = less surplus substrates being outplanted to the reef

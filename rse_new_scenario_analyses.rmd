...
plot(x = prop_set, y = ceiling(rest_pars$lab_max*prop_set/2000), type = "l", ylim = c(0, 6), las = 1, ylab = "Days spent outplanting", xlab = "Prop. initially outplanted to reef")
lines(x = prop_set, y = ceiling(rest_pars$lab_max*(1-prop_set)/800), col = "dodgerblue")
lines(x = prop_set, y = ceiling(rest_pars$lab_max*prop_set/2000) + ceiling(rest_pars$lab_max*(1-prop_set)/800), col = "red")
...
ts_plot1(plot_sims = sims_lambdaR1, yrs_p = years, legend2_title = "Reference reef supply", legend2_labs = c("none","default"), par_ltys = c(2, 1), ymaxs = c(60, 6000, rest_pars$lab_max, rest_pars$orchard_size))
...
ts_plot1(plot_sims = sims_lab_max1, yrs_p = years, legend2_title = "Lab capacity", legend2_labs = c("default", "2x default"), par_ltys = c(1, 2), ymaxs = c(110, 6000, rest_pars$lab_max*2, rest_pars$orchard_size), add_h3 = T)
...
ts_plot1(plot_sims = sims_orchard_size1, yrs_p = years, legend2_title = "Orchard capacity", legend2_labs = c("default", "2x default"), par_ltys = c(1, 2), ymaxs = c(60, 10000, rest_pars$lab_max, rest_pars$orchard_size*2), add_h4 = T)

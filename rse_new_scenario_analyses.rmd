...
orch_fun_ij <- model_summ(model_sim = sim_ij, location = "orchard", metric = "area_m2", n_reef = length(reef_treatments), n_orchard = length(orchard_treatments), n_lab = length(lab_treatments), size_classes = c(3, 4, 5))
    ...
    # outplanting and orchard maintenance costs
      ...
      #  c_reef[ii-1] <- (300 + 200)*ceiling(sim_ij$reef_tiles_out[ii]/2000) + 380/2000 * sim_ij$reef_tiles_out[ii]
        
      #  c_orch[ii-1] <- (300 + 200)*ceiling(sim_ij$orchard_tiles_out[ii]/800) + 250/2000 * sim_ij$orchard_tiles_out[ii]
        
 # update so the ceiling (per day costs) only apply to the boat costs
        c_reef[ii-1] <- 300*ceiling(sim_ij$reef_tiles_out[ii]/2000) + 200*sim_ij$reef_tiles_out[ii]/2000 + 380/2000*sim_ij$reef_tiles_out[ii]
...
```{r}
weights1 <- list(reef_cover = 1, orch_fun = 1, reef_ROI = 1, tot_ROI = 1, tot_costs = 1, recruits_out = 1)
...
# function for extracting performance metrics from the orchard expansion simulations
orch_exp_sens_fun <- function(sim_list, par_set2, L2, L1, max_yr, weights = list(reef_cover = 1, orch_fun = 1, reef_ROI = 1, tot_ROI = 1, tot_costs = 1, recruits_out = 1), dt_D0 = data.frame(NA)){
...
# process the results
lambda_R2_dt5 <- orch_exp_sens_fun(sim_list = sens_lambda_R2, par_set2 = lambda_R_setL, L2, L1, max_yr = 5, weights = list(reef_cover = 1, orch_fun = 1, reef_ROI = 1, tot_ROI = 1, tot_costs = 1, recruits_out = 1), dt_D0 = data.frame(NA))
 
lambda_R2_dt50 <- orch_exp_sens_fun(sim_list = sens_lambda_R2, par_set2 = lambda_R_setL, L2, L1, max_yr = 50, weights = list(reef_cover = 1, orch_fun = 1, reef_ROI = 1, tot_ROI = 1, tot_costs = 1, recruits_out = 1), dt_D0 = data.frame(NA))
...
# process the results
lab_max2_dt5 <- orch_exp_sens_fun(sim_list = sens_lab_max2, par_set2 = lab_max_setL, L2, L1, max_yr = 5, weights = list(reef_cover = 1, orch_fun = 1, reef_ROI = 1, tot_ROI = 1, tot_costs = 1, recruits_out = 1), dt_D0 = data.frame(NA))

lab_max2_dt50 <- orch_exp_sens_fun(sim_list = sens_lab_max2, par_set2 = lab_max_setL, L2, L1, max_yr = 50, weights = list(reef_cover = 1, orch_fun = 1, reef_ROI = 1, tot_ROI = 1, tot_costs = 1, recruits_out = 1), dt_D0 = data.frame(NA))
